...
using (var db = new SciencePortalDbContext())
{
    ...
    var newPublication = new Publication
    {
        ...
        Type = "статья",
        // ИСПРАВЛЕНО: Присваиваем полную дату, а не просто число (вы говорили исправить в комментарии под превой лабораторной)
    ...
    {
        // ИСПРАВЛЕНО: Присваиваем новую полную дату
    ...
    if (directionToDelete != null)
    {
        ...
        db.SaveChanges();
        Console.WriteLine($"Направление с ID {newDirection.DirectionId} удалено.");
    }
